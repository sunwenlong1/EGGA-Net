...
class GAM_Attention(nn.Module):
    def __init__(self, planes, rate=4):
        ...
        self.spatial_attention = nn.Sequential(
            nn.Conv2d(planes, int(planes / rate), kernel_size=7, padding=3),
            nn.BatchNorm2d(int(planes / rate)),
            nn.ReLU(inplace=True),
            nn.Conv2d(int(planes / rate), planes, kernel_size=7, padding=3),
...
#
#         self.out_conv = nn.Conv2d(self.ft_chns[0], self.n_class, kernel_size=3, padding=1)
#         # Adding edge attention module
#         self.edge_attention = EdgeAttention(self.ft_chns[0], self.ft_chns[0])
#
#     def forward(self, feature):
#         x0 = feature[0]
#         x1 = feature[1]
